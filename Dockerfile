...
# pocket
ENV POKT_MNEMONIC ${POKT_MNEMONIC}
ENV POKT_GCP_KMS_KEY_NAME ${POKT_GCP_KMS_KEY_NAME}
ENV POKT_RPC_URL ${POKT_RPC_URL}
ENV POKT_GRPC_ENABLED ${POKT_GRPC_ENABLED}
ENV POKT_GRPC_HOST ${POKT_GRPC_HOST}
ENV POKT_GRPC_PORT ${POKT_GRPC_PORT}
...
ENV POKT_COIN_DENOM ${POKT_COIN_DENOM}
ENV POKT_BECH32_PREFIX ${POKT_BECH32_PREFIX}
ENV POKT_MULTISIG_ADDRESS ${POKT_MULTISIG_ADDRESS}
ENV POKT_MULTISIG_THRESHOLD ${POKT_MULTISIG_THRESHOLD}
ENV POKT_MULTISIG_PUBLIC_KEYS ${POKT_MULTISIG_PUBLIC_KEYS}
ENV POKT_MINT_DISABLED ${POKT_MINT_DISABLED}
