...
docker_build_beta :; docker buildx build . --platform linux/amd64,linux/arm64 -t dan13ram/wpokt-validator-beta:v0.2.7 --file ./docker/Dockerfile.beta

.PHONY: docker_push_beta
docker_push_beta :; docker buildx build . --platform linux/amd64,linux/arm64 -t dan13ram/wpokt-validator-beta:v0.2.7 --file ./docker/Dockerfile.beta --push

.PHONY: docker_build
docker_build :; docker buildx build . --platform linux/amd64,linux/arm64 -t dan13ram/wpokt-validator:v0.2.7 --file ./docker/Dockerfile.mainnet

.PHONY: docker_push
docker_push :; docker buildx build . --platform linux/amd64,linux/arm64 -t dan13ram/wpokt-validator:v0.2.7 --file ./docker/Dockerfile.mainnet --push
