...
func (_m *MockCosmosHTTPClient) CheckTx(ctx context.Context, tx types.Tx) (*coretypes.ResultCheckTx, error) {
	ret := _m.Called(ctx, tx)
...
// MockCosmosHTTPClient_CheckTx_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckTx'
type MockCosmosHTTPClient_CheckTx_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - tx types.Tx
func (_e *MockCosmosHTTPClient_Expecter) CheckTx(ctx interface{}, tx interface{}) *MockCosmosHTTPClient_CheckTx_Call {
	return &MockCosmosHTTPClient_CheckTx_Call{Call: _e.mock.On("CheckTx", ctx, tx)}
}

func (_c *MockCosmosHTTPClient_CheckTx_Call) Run(run func(ctx context.Context, tx types.Tx)) *MockCosmosHTTPClient_CheckTx_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.Tx))
	})
	return _c
...
func (_c *MockCosmosHTTPClient_CheckTx_Call) Return(_a0 *coretypes.ResultCheckTx, _a1 error) *MockCosmosHTTPClient_CheckTx_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCosmosHTTPClient_CheckTx_Call) RunAndReturn(run func(context.Context, types.Tx) (*coretypes.ResultCheckTx, error)) *MockCosmosHTTPClient_CheckTx_Call {
	_c.Call.Return(run)
	return _c
}
