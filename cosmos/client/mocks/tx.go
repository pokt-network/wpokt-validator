...
// FeeGranter provides a mock function with no fields
...
// FeePayer provides a mock function with no fields
...
// GetFee provides a mock function with no fields
...
// GetGas provides a mock function with no fields
...
// GetMemo provides a mock function with no fields
...
// GetPubKeys provides a mock function with no fields
...
// GetSignaturesV2 provides a mock function with no fields
...
// GetSigners provides a mock function with no fields
...
// GetTimeoutHeight provides a mock function with no fields
...
// GetTimeoutTimeStamp provides a mock function with no fields
func (_m *MockTx) GetTimeoutTimeStamp() time.Time {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetTimeoutTimeStamp")
	}
...
// MockTx_GetTimeoutTimeStamp_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTimeoutTimeStamp'
type MockTx_GetTimeoutTimeStamp_Call struct {
	*mock.Call
}

// GetTimeoutTimeStamp is a helper method to define mock.On call
func (_e *MockTx_Expecter) GetTimeoutTimeStamp() *MockTx_GetTimeoutTimeStamp_Call {
	return &MockTx_GetTimeoutTimeStamp_Call{Call: _e.mock.On("GetTimeoutTimeStamp")}
}

func (_c *MockTx_GetTimeoutTimeStamp_Call) Run(run func()) *MockTx_GetTimeoutTimeStamp_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockTx_GetTimeoutTimeStamp_Call) Return(_a0 time.Time) *MockTx_GetTimeoutTimeStamp_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTx_GetTimeoutTimeStamp_Call) RunAndReturn(run func() time.Time) *MockTx_GetTimeoutTimeStamp_Call {
	_c.Call.Return(run)
	return _c
}

// GetUnordered provides a mock function with no fields
func (_m *MockTx) GetUnordered() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetUnordered")
	}
...
// MockTx_GetUnordered_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetUnordered'
type MockTx_GetUnordered_Call struct {
	*mock.Call
}

// GetUnordered is a helper method to define mock.On call
func (_e *MockTx_Expecter) GetUnordered() *MockTx_GetUnordered_Call {
	return &MockTx_GetUnordered_Call{Call: _e.mock.On("GetUnordered")}
}

func (_c *MockTx_GetUnordered_Call) Run(run func()) *MockTx_GetUnordered_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockTx_GetUnordered_Call) Return(_a0 bool) *MockTx_GetUnordered_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTx_GetUnordered_Call) RunAndReturn(run func() bool) *MockTx_GetUnordered_Call {
	_c.Call.Return(run)
	return _c
}

// ValidateBasic provides a mock function with no fields
