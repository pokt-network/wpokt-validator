...
func (_c *MockTxBuilder_SetMsgs_Call) Run(run func(msgs ...proto.Message)) *MockTxBuilder_SetMsgs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTxBuilder_SetMsgs_Call) RunAndReturn(run func(...proto.Message) error) *MockTxBuilder_SetMsgs_Call {
	_c.Call.Return(run)
	return _c
}
