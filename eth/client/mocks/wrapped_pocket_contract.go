...
func (_m *MockWrappedPocketContract) FilterBurnAndBridge(opts *bind.FilterOpts, amount []*big.Int, poktAddress []common.Address, from []common.Address) (client.WrappedPocketBurnAndBridgeIterator, error) {
	ret := _m.Called(opts, amount, poktAddress, from)

	if len(ret) == 0 {
		panic("no return value specified for FilterBurnAndBridge")
	}

	var r0 client.WrappedPocketBurnAndBridgeIterator
	var r1 error
	if rf, ok := ret.Get(0).(func(*bind.FilterOpts, []*big.Int, []common.Address, []common.Address) (client.WrappedPocketBurnAndBridgeIterator, error)); ok {
		return rf(opts, amount, poktAddress, from)
	}
	if rf, ok := ret.Get(0).(func(*bind.FilterOpts, []*big.Int, []common.Address, []common.Address) client.WrappedPocketBurnAndBridgeIterator); ok {
		r0 = rf(opts, amount, poktAddress, from)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(client.WrappedPocketBurnAndBridgeIterator)
		}
	}
...
func (_c *MockWrappedPocketContract_FilterBurnAndBridge_Call) Return(_a0 client.WrappedPocketBurnAndBridgeIterator, _a1 error) *MockWrappedPocketContract_FilterBurnAndBridge_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWrappedPocketContract_FilterBurnAndBridge_Call) RunAndReturn(run func(*bind.FilterOpts, []*big.Int, []common.Address, []common.Address) (client.WrappedPocketBurnAndBridgeIterator, error)) *MockWrappedPocketContract_FilterBurnAndBridge_Call {
	_c.Call.Return(run)
	return _c
}

// FilterMinted provides a mock function with given fields: opts, recipient, amount, nonce
func (_m *MockWrappedPocketContract) FilterMinted(opts *bind.FilterOpts, recipient []common.Address, amount []*big.Int, nonce []*big.Int) (client.WrappedPocketMintedIterator, error) {
	ret := _m.Called(opts, recipient, amount, nonce)

	if len(ret) == 0 {
		panic("no return value specified for FilterMinted")
	}

	var r0 client.WrappedPocketMintedIterator
	var r1 error
	if rf, ok := ret.Get(0).(func(*bind.FilterOpts, []common.Address, []*big.Int, []*big.Int) (client.WrappedPocketMintedIterator, error)); ok {
		return rf(opts, recipient, amount, nonce)
	}
	if rf, ok := ret.Get(0).(func(*bind.FilterOpts, []common.Address, []*big.Int, []*big.Int) client.WrappedPocketMintedIterator); ok {
		r0 = rf(opts, recipient, amount, nonce)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(client.WrappedPocketMintedIterator)
		}
	}
...
func (_c *MockWrappedPocketContract_FilterMinted_Call) Return(_a0 client.WrappedPocketMintedIterator, _a1 error) *MockWrappedPocketContract_FilterMinted_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWrappedPocketContract_FilterMinted_Call) RunAndReturn(run func(*bind.FilterOpts, []common.Address, []*big.Int, []*big.Int) (client.WrappedPocketMintedIterator, error)) *MockWrappedPocketContract_FilterMinted_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockWrappedPocketContract) GetUserNonce(opts *bind.CallOpts, user common.Address) (*big.Int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetUserNonce")
	}
...
func (_m *MockWrappedPocketContract) ParseBurnAndBridge(log types.Log) (*autogen.WrappedPocketBurnAndBridge, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ParseBurnAndBridge")
	}
